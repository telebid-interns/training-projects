...
function twentyseventeen_scripts() {
    ...
    wp_enqueue_script('formchanges', get_theme_file_uri('/js/formchanges.js'));
    wp_enqueue_script('google-map', get_theme_file_uri('/js/google-maps.js'), array('formchanges'));
    // wp_enqueue_style('map_style', get_template_directory_uri() . '/map_style.css', false, '1.0');
}
